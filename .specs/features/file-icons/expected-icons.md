# File Icons — Expected Icons (dark theme)
...
| Name | Kind | Icon (closed / file) | Icon (open) |
| ---- | ---- | -------------------- | ----------- |
...
| `MainWindow.xaml.cs` | file | `file-type-csharp` | — |
| `Module1.vb` | file | `file-type-vb` | — |
| `Resources.resx` | file | `file-type-xml` | — |
| `App.config` | file | `file-type-xml` | — |
| `Acme.Widget.Desktop.vbproj` | file | `file-type-vbproj` | — |
| `Acme.Widget.Pricing` | folder | `default-folder` | `default-folder-opened` |
| `Pricing.fs` | file | `file-type-fsharp` | — |
| `Acme.Widget.Pricing.fsproj` | file | `file-type-fsproj` | — |
| `Acme.Widget.Native` | folder | `default-folder` | `default-folder-opened` |
| `engine.cpp` | file | `file-type-cpp` | — |
| `engine.h` | file | `file-type-cheader` | — |
| `Acme.Widget.Native.vcxproj` | file | `file-type-vcxproj` | — |
| `web` | folder | `default-folder` | `default-folder-opened` |
| `components` | folder | `folder-type-component` | `folder-type-component-opened` |
| `OrderList.tsx` | file | `file-type-reactts` | — |
| `OrderList.test.tsx` | file | `file-type-testts` | — |
| `main.ts` | file | `file-type-typescript` | — |
| `styles.scss` | file | `file-type-scss` | — |
| `index.html` | file | `file-type-html` | — |
...
| `Migrations` | folder | `default-folder` | `default-folder-opened` |
| `001. Create orders.sql` | file | `file-type-sql` | — |
| `scripts` | folder | `folder-type-script` | `folder-type-script-opened` |
| `build.ps1` | file | `file-type-powershell` | — |
| `deploy.sh` | file | `file-type-shell` | — |
| `setup.bat` | file | `file-type-bat` | — |
| `report.py` | file | `file-type-python` | — |
| `docs` | folder | `folder-type-docs` | `folder-type-docs-opened` |
| `architecture.md` | file | `file-type-markdown` | — |
| `diagram.png` | file | `file-type-image` | — |
| `contract.pdf` | file | `file-type-pdf2` | — |
...
| `Acme.Widget.sln` | file | `file-type-sln` | — |
...
| `README.md` | file | `file-type-markdown` | — |
| `LICENSE` | file | `file-type-license` | — |
| `CHANGELOG.md` | file | `file-type-markdown` | — |
| `Makefile` | file | `file-type-makefile` | — |
| `release.zip` | file | `file-type-zip` | — |
