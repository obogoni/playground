...
- [ ] **agent-task-context**: hand-verify in dev (registered workspace + pinned task matching a worktree branch) + open PR `feature/agent-task-context` → main (`Closes #<n>`)
